...
const FOUNDER_AMBASSADOR_TIER = 'diamond';
const FOUNDER_COMMISSION_PERCENT = 6;
 ...
 * @returns {boolean}
 */
const isFounderAmbassadorProfile = (publicData = {}) => {
  const pd = publicData || {};
 ...
 */
const logFounderOverride = payload => {
 ...
 * @returns {object}
 */
const resolveAmbassadorFounderOverride = ({ publicData, userId } = {}) => {
 ...
 * @returns {object}
 */
const applyFounderBronzeProgressOverride = bronzeProgress => {
