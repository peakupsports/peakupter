...
/**
 * Localized override for the landing page "How PeakUp Sports Works" three-card section.
    ...
    >
      <header className={defaultClasses.sectionDetails}>
        <h2 className={defaultClasses.title}>
          <FormattedMessage
            id="LandingHowItWorksSection.title"
            defaultMessage="How PeakUp Sports Works"
          />
        </h2>
